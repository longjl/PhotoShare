 ...
 */
package com.tintinshare.activities;
...
import com.tintinshare.platform.Platform;
import com.tintinshare.views.CropImageView;
import com.tintinshare.views.HighlightView;
import com.tintinshare.views.PhotoImageView;

public class CropImageActivity extends PhotoFragmentActivity implements PhotoImageView.OnPhotoLoadListener {

    static Photo CROP_SELECTION;

    private CropImageView mCropImageView;
    private HighlightView mHighlightView;

    private Photo mPhotoUpload;
